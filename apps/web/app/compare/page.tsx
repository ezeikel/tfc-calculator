...
export const metadata: Metadata = {
  ...
  keywords: "tax free childcare vs universal credit, childcare vouchers comparison, TFC vs other schemes, best childcare support UK, childcare benefits comparison"
}
